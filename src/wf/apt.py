...
class _SimplePatternAPParser(Frozen):
    ...
    def _parse_reprs_d_(self, test_form=None):
        ...
        if test_form == self._wft._f1:
            ...
            term = v1 @ mass_matrix @ d_matrix @ v0
        else:
            v0 = bf0.ap().T
            v1 = self._wft._f1.ap()
    ...
    def _parse_reprs__d(self, test_form=None):
        ...
        if test_form == bf1:
            v0 = self._wft._f0.ap()
            v1 = bf1.ap().T
            term = v1 @ d_matrix.T @ mass_matrix @ v0
        else:
    ...
    def _parse_reprs_tr_star_star(self, test_form=None):
        ...
        if test_form == bf1:
            term = v1.T @ trace_matrix.T @ boundary_wedge_vector
        else:
